...
def plot_3scores(s1, s2, s3, lab1, lab2, lab3):
    ...
    ax.plot(range(1, l + 1), s1, color='cyan', label=lab1, alpha=0.8)
    ax.plot(range(1, l + 1), s2, color='magenta', label=lab2, alpha=0.5)
    ax.plot(range(1, l + 1), s3, color='red', label=lab3)
    plt.legend()
